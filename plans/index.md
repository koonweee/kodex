...
| [Mobile composer plan](mobile-composer.md) | Proposed | Mobile-specific composer representations sharing desktop composer logic | Adds compact dock, focused keyboard-aware bottom sheet, expanded compose sheet, and mobile skill command sheet based on generated mockups. |
