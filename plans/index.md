...
| [Timeline rendering feedback fixes plan](timeline-rendering-feedback-fixes.md) | Proposed | File-change diff viewing, failed command status, and local Markdown side-pane preview | Excludes native plan rendering and fixture/dev QA pages by request. |
