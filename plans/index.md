...
| [Collaboration agent timeline rendering plan](collab-agent-timeline-rendering.md) | Proposed | Friendly subagent names, structured collab activity rows, Markdown result previews, and Codex TUI parity cues | Keeps raw IDs in debug and avoids gateway/API changes for the first pass. |
