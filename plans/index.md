...
| [Image preview serving plan](image-preview-serving.md) | Proposed | Gateway-served previews for app-server generated images, image views, and tool-output image content | Concrete plan for thread-scoped local image preview serving, frontend image asset normalization, renderer fallbacks, and verification. |
