...
| [Timeline replay removal plan](timeline-replay-removal.md) | Proposed | Remove persisted timeline event replay from canonical thread loading and recovery | Follow-up plan to make selected thread load deterministic: snapshot first, transient live streaming second, replay only for gateway-owned approvals/debug state. |
