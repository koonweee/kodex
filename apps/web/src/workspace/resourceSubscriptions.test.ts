...
describe("workspaceSubscribedThreadIds", () => {
  it("dedupes thread resources across duplicate thread and generated UI panes", () => {
    const panes: WorkspacePane[] = [
      ...
      pane("pane-c", "generatedUi", { mode: "latest", threadId: "thread-1" }),
      pane("pane-d", "generatedUi", { mode: "latest", threadId: "thread-2" }),
