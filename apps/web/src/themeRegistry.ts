...
export const KODEX_COLOR_SCHEMES: KodexColorSchemeDefinition[] = [
  {
    id: "oled-black",
    label: "OLED Black",
    description: "Pitch-black surfaces with muted green accents.",
    mode: "dark",
    swatches: ["#050505", "#111111", "#38a96a"],
    rootVariables: {
      "--kodex-bg-app": "#050505",
      ...
      "--kodex-bg-selected": "#10251a",
      "--kodex-bg-selected-strong": "#173821",
      "--kodex-bg-command": "#1b1d22",
      "--kodex-bg-code": "#13211e",
      "--kodex-bg-empty-icon": "#202020",
      "--kodex-bg-mobile": "#0f0f0f",
      "--kodex-bg-user-bubble": "#25784d",
      "--kodex-border-subtle": "#2b2b2b",
      "--kodex-border-strong": "#3d3d3d",
      "--kodex-border-accent": "#38a96a",
      "--kodex-border-accent-soft": "rgb(56 169 106 / 42%)",
      "--kodex-text-primary": "#f3f3f3",
      "--kodex-text-secondary": "#d0d0d0",
      "--kodex-text-muted": "#8d8d8d",
      "--kodex-text-accent": "#7fd79d",
      "--kodex-text-accent-soft": "#cdf5d8",
      "--kodex-text-on-accent": "#f7fff9",
      "--kodex-text-danger": "#ffb4a8",
      "--kodex-accent": "#38a96a",
      "--kodex-accent-strong": "#6fd293",
      "--kodex-accent-muted": "#95ad9c",
      "--kodex-danger": "#ff8e7a",
      ...
      "--kodex-bg-warning": "rgb(244 201 93 / 14%)",
      "--kodex-bg-danger": "rgb(255 142 122 / 14%)",
      "--kodex-bg-info": "rgb(130 207 255 / 14%)",
      "--kodex-bg-success": "rgb(56 169 106 / 14%)",
    ...
    mantineAccent: ["#0d1711", "#102016", "#15301f", "#7fd79d", "#205635", "#286b42", "#308151", "#37975f", "#38a96a", "#6fd293"],
  ...
  },
  {
    ...
    rootVariables: {
      ...
      "--kodex-bg-warning": "rgb(169 111 0 / 12%)",
      "--kodex-bg-danger": "rgb(194 93 75 / 12%)",
      "--kodex-bg-info": "rgb(27 111 159 / 12%)",
      "--kodex-bg-success": "rgb(13 138 116 / 12%)",
  ...
  },
  {
    ...
    rootVariables: {
      ...
      "--kodex-bg-warning": "rgb(241 250 140 / 14%)",
      "--kodex-bg-danger": "rgb(255 149 128 / 14%)",
      "--kodex-bg-info": "rgb(139 233 253 / 14%)",
      "--kodex-bg-success": "rgb(80 250 123 / 14%)",
  ...
  },
  {
    ...
    rootVariables: {
      ...
      "--kodex-bg-warning": "rgb(255 216 102 / 14%)",
      "--kodex-bg-danger": "rgb(255 97 136 / 14%)",
      "--kodex-bg-info": "rgb(120 220 232 / 14%)",
      "--kodex-bg-success": "rgb(166 226 46 / 14%)",
