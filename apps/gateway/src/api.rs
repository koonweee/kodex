...
use crate::{
    ...
    routes::{
        ...
        app_surfaces::{
            AppSurfaceBridgeError, AppSurfaceBridgeRequest, AppSurfaceBridgeResponse,
            AppSurfaceDocumentQuery, AppSurfacePresentationAction,
            AppSurfacePresentationRequestDto, AppSurfacePresentationResponse, AppSurfaceSessionDto,
            AppSurfaceSessionReadResponse, AppSurfaceSessionResponse,
        },
        ...
        self_control::{
            SelfControlAppSurfacePresentationRequest, SelfControlApplyAction,
            SelfControlApplyChange, SelfControlApprovalDecisionRequest,
            ...
            SelfControlGeneratedAppSurfaceUpsertRequest, SelfControlGeneratedUiUpsertRequest,
            SelfControlMarkThreadSeenRequest, SelfControlMutationRequest,
            SelfControlPreviewApplyRequest, SelfControlPreviewApplyResponse,
            SelfControlRenameThreadRequest, SelfControlRequestedBy, SelfControlSource,
            SelfControlSourceType, SelfControlStatusResponse, SelfControlThreadInputAction,
            SelfControlThreadInputRequest, SelfControlThreadInputResponse,
            SelfControlThreadPayloadMutationRequest, SelfControlThreadSettingsUpdateRequest,
    ...
    store::{
        ...
        AppSurfaceSession, AppSurfaceSessionStatus, AppSurfaceToolGrant, Approval,
        AutomationStatus, EventEnvelope, GeneratedUiSession, GeneratedUiSessionStatus, Project,
        ProjectPreview, ProjectPreviewRoute, ProjectPreviewService, QueuedInput,
...
#[openapi(
    paths(
        ...
        crate::routes::app_surfaces::get_thread_app_surface,
        crate::routes::app_surfaces::app_surface_document,
        crate::routes::app_surfaces::app_surface_bridge,
        ...
        crate::routes::thread_presence::replace_thread_view_presence,
        ...
        crate::routes::self_control::get_self_control_app_surface,
        crate::routes::self_control::upsert_self_control_generated_app_surface,
        crate::routes::self_control::request_self_control_app_surface_presentation,
        crate::routes::self_control::archive_self_control_app_surface,
