...
- `GET /v1/self-control/status`, `POST /v1/self-control/project-previews/apply`, `POST /v1/self-control/threads`, `POST /v1/self-control/threads/{threadId}/input`, self-control app-surface routes under `/v1/self-control/threads/{threadId}/app-surface`, legacy generated UI aliases under `/v1/self-control/threads/{threadId}/generated-ui`, and self-control automation routes under `/v1/self-control/automations` for guarded agent-facing Kodex Control mutations. MCP tools should use these routes instead of raw CRUD routes so provenance and safety policy stay gateway-owned.
